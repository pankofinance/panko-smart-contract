...
async function main() {
  ...
  const V3LmPoolDeployer = await ethers.getContractFactory('GainV3LmPoolDeployer')
  ...
  const v3Factory = new ethers.Contract(v3Factory_address, GainV3FactoryABI, owner)
