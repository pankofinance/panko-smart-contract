...
import './SwapLabsStableSwapThreePool.sol';

contract SwapLabsStableSwapThreePoolDeployer is Ownable {
    ...
    function createSwapPair(
        ...
        bytes memory bytecode = type(SwapLabsStableSwapThreePool).creationCode;
        ...
        SwapLabsStableSwapThreePool(swapContract).initialize(coins, _A, _fee, _admin_fee, _admin, _LP);
