...
import './GainStableSwapLP.sol';

contract GainStableSwapLPFactory is Ownable {
    ...
    function createSwapLP(
        ...
        // create LP token
        bytes memory bytecode = type(GainStableSwapLP).creationCode;
        ...
        GainStableSwapLP(lpToken).setMinter(_minter);
