...
import './GainStableSwapThreePool.sol';

contract GainStableSwapThreePoolDeployer is Ownable {
    ...
    function createSwapPair(
        ...
        bytes memory bytecode = type(GainStableSwapThreePool).creationCode;
        ...
        GainStableSwapThreePool(swapContract).initialize(coins, _A, _fee, _admin_fee, _admin, _LP);
