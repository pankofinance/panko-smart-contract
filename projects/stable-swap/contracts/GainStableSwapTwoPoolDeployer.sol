...
import './GainStableSwapTwoPool.sol';

contract GainStableSwapTwoPoolDeployer is Ownable {
    ...
    function createSwapPair(
        ...
        bytes memory bytecode = type(GainStableSwapTwoPool).creationCode;
        ...
        GainStableSwapTwoPool(swapContract).initialize(coins, _A, _fee, _admin_fee, _admin, _LP);
