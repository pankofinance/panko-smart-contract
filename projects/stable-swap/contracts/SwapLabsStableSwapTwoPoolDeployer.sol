...
import './SwapLabsStableSwapTwoPool.sol';

contract SwapLabsStableSwapTwoPoolDeployer is Ownable {
    ...
    function createSwapPair(
        ...
        bytes memory bytecode = type(SwapLabsStableSwapTwoPool).creationCode;
        ...
        SwapLabsStableSwapTwoPool(swapContract).initialize(coins, _A, _fee, _admin_fee, _admin, _LP);
