...
const PancakeStableSwapFactory = artifacts.require('stable-swap/contracts/GainStableSwapFactory.sol')
const PancakeStableSwapLPFactory = artifacts.require('stable-swap/contracts/GainStableSwapLPFactory.sol')
const PancakeStableSwapTwoPoolDeployer = artifacts.require('stable-swap/contracts/GainStableSwapTwoPoolDeployer.sol')
const PancakeStableSwapThreePoolDeployer = artifacts.require(
  'stable-swap/contracts/GainStableSwapThreePoolDeployer.sol'
)
const PancakeStableSwapTwoPool = artifacts.require('stable-swap/contracts/GainStableSwapTwoPool.sol')
const PancakeStableSwapThreePool = artifacts.require('stable-swap/contracts/GainStableSwapThreePool.sol')
...
const PancakeStableSwapInfo = artifacts.require('stable-swap/contracts/utils/GainStableSwapInfo.sol')
const LPToken = artifacts.require('stable-swap/contracts/GainStableSwapLP.sol')
...
const PancakeFactory = artifacts.require('exchange-protocol/contracts/GainFactory.sol')
const PancakePair = artifacts.require('exchange-protocol/contracts/GainPair.sol')
const PancakeRouter = artifacts.require('exchange-protocol/contracts/GainRouter.sol')
