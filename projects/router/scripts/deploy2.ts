...
async function main() {
  ...
  const stableSwapDeployedContracts = await import(`@pancakeswap/stable-swap/deployed/${networkName}.json`)
  ...
  const stableSwapFactory_address = stableSwapDeployedContracts.StableSwapFactory
  const stableSwapInfo_address = stableSwapDeployedContracts.StableSwapInfo
